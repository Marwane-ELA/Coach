...
import com.marwane.coach.adapter.DeviceListAdapter;
 ...
 * https://www.youtube.com/watch?v=hv_-tX1VwXE&index=3&list=PLgCYzUzKIBE8KHMzpp6JITZ2JxTgWqDH2
 * https://www.youtube.com/watch?v=YJ0JQXcNNTA&index=4&list=PLgCYzUzKIBE8KHMzpp6JITZ2JxTgWqDH2
 *
 */
public class BluetoothActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CVBT = (CardView)findViewById(R.id.CVONOFF);
        CVDiscov = (CardView)findViewById(R.id.CVDisco);
        lvNewDevices = (ListView)findViewById(R.id.lvNewDevices);
        mBTDevices = new ArrayList<>();
        setToggleEvent();

        ecouteMenu((CardView)findViewById(R.id.homeBT),MainActivity.class);
        ...
        if(!mBluetoothAdapter.isEnabled()){
            CVBT.setCardBackgroundColor(Color.parseColor("#FFFFFF"));
        }
        else  if(mBluetoothAdapter.isEnabled()){
            CVBT.setCardBackgroundColor(Color.parseColor("#48CFAD"));
        }


        //Drawer
        nv = (NavigationView)findViewById(R.id.nv8);

        mDrawerLayout = (DrawerLayout) findViewById(R.id.drawBT);
    ...
    private void ecouteMenu(CardView btn, final Class classe){
        btn.setOnClickListener(new ImageButton.OnClickListener(){
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(BluetoothActivity.this, classe);
    ...
    public void enableDisableBT(){
       if(mBluetoothAdapter == null){
        ...
        if(!mBluetoothAdapter.isEnabled()){
            ...
            registerReceiver(mBroadcastReceiver1, BTIntent);//catch de state changes of the bluetooth
        }
        //disabled bluetooth
        if(mBluetoothAdapter.isEnabled()){
    ...
    public void btnEnableDisable_Discoverable(View view) {
        ...
        Toast.makeText(this,"Discover mode: 300 seconds",Toast.LENGTH_SHORT).show();

        Intent discoverableIntent = new Intent(BluetoothAdapter.ACTION_REQUEST_DISCOVERABLE);
        discoverableIntent.putExtra(BluetoothAdapter.EXTRA_DISCOVERABLE_DURATION, 300);//duration
    ...
    private void setToggleEvent() {
        //Loop all child item of Main Grid
            ...
            CVBT.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (CVBT.getCardBackgroundColor().getDefaultColor() == -1) {
    ...
    public void btnDiscover(View view) {
        ...
        if(mBluetoothAdapter.isDiscovering()){
            mBluetoothAdapter.cancelDiscovery(); //look if the app is in discovery mode and restart it
